...
# YOLO SETUP
# ============================================================================
model = YOLO("C:\\Users\\Aatif\\Desktop\\Artikate_Studio\\weights\\best.pt")   #Best

# model = YOLO("runs/detect/train/weights/best.pt")  #DETECTION YOLOV8

# model = RTDETR("RT-DETR/best.pt")  # DETECTION RT-DETR
...
if __name__ == "__main__":
    ...
    right_title = tk.Label(right_frame, text="Predicted Result", font=("Arial", 20, "bold"), bg="white", fg="#1976D2")
